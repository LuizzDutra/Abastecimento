...
def test_regra_improper_data():
    ...
    test_improper_data: list[bool] = [
        ...
        anomalia(media_mock[TipoCombustivel.GASOLINA] * perc, TipoCombustivel.GASOLINA),
        anomalia(Decimal(15.00), TipoCombustivel.DIESEL),
        anomalia(media_mock[TipoCombustivel.DIESEL] * perc, TipoCombustivel.DIESEL),
        anomalia(Decimal(12.00), TipoCombustivel.ETANOL),
        anomalia(media_mock[TipoCombustivel.ETANOL] * perc, TipoCombustivel.ETANOL),
    ]
